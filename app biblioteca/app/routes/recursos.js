...
router.get('/llibres', async (req, res, next) => {
    try {
...
router.get('/revistes', async (req, res, next) => {
    try {
...
router.get('/pelicules', async (req, res, next) => {
    try {
...
router.post('/addMaterial', async (req, res, next) => {
    const {titol, NumExemplars,tipus} = req.body;
    try{
        const [result] = await pool.query(
          'INSERT INTO Material (titol,NumExemplars,tipus) VALUES(?,?,?)',
          [titol,NumExemplars,tipus]  
        );
...
router.post('/addLlibre', async (req, res, next) => {
...
router.post('/addPelicula', async (req, res, next) => {
...
router.put('/updLlibre/:id', async (req, res, next) => {
    const { id } = req.params;
    const { autor, material_id } = req.body;
...
router.put('/updRevista/:id', async (req, res, next) => {
    const { id } = req.params;
    const { dataPublicacio, material_id } = req.body;
